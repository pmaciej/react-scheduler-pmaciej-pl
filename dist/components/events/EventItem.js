...
var EventItem = function (_a) {
    ...
    var item = (_jsxs("div", __assign({ style: { padding: 2 } }, { children: [_jsx(Typography, __assign({ variant: "subtitle2", color: "#FFF", style: { fontSize: 12 }, noWrap: true }, { children: event.title }), void 0), showdate && (_jsx(Typography, __assign({ style: { fontSize: 11 }, noWrap: true }, { children: format(event.start, "HH:mm", {
                    locale: locale,
                }) + " - " + format(event.end, "HH:mm", { locale: locale }) }), void 0))] }), void 0));
    if (multiday) {
